...
from sc_django.views import index, overview, acknowledgments, searchform, issues, issue_toc, issue_display, article_display, topics, topic_toc

urlpatterns = patterns('sc_django.views',
